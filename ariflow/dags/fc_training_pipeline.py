...
#         description='Finance Complaint ML Spark Porject',
...
#                                                               ModelTrainerArtifact, ModelEvaluationArtifact, ModelPusherArtifact, PartialModelTrainerRefArtifact,
#                                                               PartialModelTrainerMetricArtifact)
#         ti = kwargs['ti']

#         data_ingestion_artifact = training_pipeline.start_data_ingestion()
#         print(data_ingestion_artifact)
#         ti.xcom_push(key='data_ingestion_artifact',
#                      value=data_ingestion_artifact)
...
#         ti.xcom_push(key='data_validation_artifact',
#                      value=data_validation_artifact)
...
#         ti.xcom_push(key='data_transformation_artifact',
#                      value=data_transformation_artifact)
...
#         ti.xcom_push('model_trainer_artifact',
...
#         ti.xcom_push('model_evaluation_artifact',
#                      model_evaluation_artifact.to_dict())
...
with DAG(
    ...
    # [END default_args]
    description='ML finance complaint Spark Project',
    schedule_interval="@weekly",
    start_date=pendulum.datetime(2023, 3, 16, tz="UTC"),
    catchup=False,
    tags=['example'],
